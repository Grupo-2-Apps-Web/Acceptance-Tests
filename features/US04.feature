Feature: US04 Seguimiento en tiempo real de envíos para cliente
...
And se muestra el listado los <envíos> que se encuentran en progreso
And selecciona uno de los viajes
Then la plataforma procesará la información 
And muestra actualizaciones en tiempo real sobre la <ubicación> y <estado> de la mercancía durante el transporte.
...
And selecciona uno de los viajes
Then la plataforma procesará la información 
And se mostrarán actualizaciones continuas sobre la <ubicación> y <estado de su mercancía>, incluyendo hitos y estimaciones de entrega.
